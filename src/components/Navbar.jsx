...
const Navbar = ({setSearch}) => {
  ...
  return (
    <>
     <div className="nav mt-3">
       ...
       <div className="button btn btn-outline-warning mx-3" onClick={()=>{setSearch('business and finance'); navigate('/')}}>Business & Finance</div>
       <div className="button btn btn-outline-primary mx-3" onClick={()=>{setSearch('tokoyo'); navigate('/')}}>Tokoyo</div>
  ...
  {location.pathname==='/' && ( <div className="container my-4" style={{width:"780px"}}>
    <div className="mb-3">
    <input type="email" className="form-control bg-dark text-light" id="exampleInputEmail1" aria-describedby="emailHelp" onChange={(e)=>setSearch(e.target.value)}/>
